...
func (c *magazineSvcClient) List(ctx context.Context, in *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	err := c.cc.Invoke(ctx, MagazineSvc_List_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *magazineSvcClient) ListByAuthorId(ctx context.Context, in *ListByAuthorIdRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListResponse)
	err := c.cc.Invoke(ctx, MagazineSvc_ListByAuthorId_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *magazineSvcClient) ListByCategory(ctx context.Context, in *ListByCategoryRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListResponse)
	err := c.cc.Invoke(ctx, MagazineSvc_ListByCategory_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *magazineSvcClient) Get(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetResponse)
	err := c.cc.Invoke(ctx, MagazineSvc_Get_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedMagazineSvcServer must be embedded to have
...
func (UnimplementedMagazineSvcServer) testEmbeddedByValue()                     {}
...
func RegisterMagazineSvcServer(s grpc.ServiceRegistrar, srv MagazineSvcServer) {
	// If the following call panics, it indicates UnimplementedMagazineSvcServer was
...
func (c *myMagazineSvcClient) Create(ctx context.Context, in *CreateMyRequest, opts ...grpc.CallOption) (*CreateMyResponse, error) {
	...
	err := c.cc.Invoke(ctx, MyMagazineSvc_Create_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *myMagazineSvcClient) Update(ctx context.Context, in *UpdateMyRequest, opts ...grpc.CallOption) (*UpdateMyResponse, error) {
	...
	err := c.cc.Invoke(ctx, MyMagazineSvc_Update_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *myMagazineSvcClient) Get(ctx context.Context, in *GetMyRequest, opts ...grpc.CallOption) (*GetMyResponse, error) {
	...
	err := c.cc.Invoke(ctx, MyMagazineSvc_Get_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *myMagazineSvcClient) Delete(ctx context.Context, in *DeleteMyRequest, opts ...grpc.CallOption) (*DeleteMyResponse, error) {
	...
	err := c.cc.Invoke(ctx, MyMagazineSvc_Delete_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *myMagazineSvcClient) List(ctx context.Context, in *ListMyRequest, opts ...grpc.CallOption) (*ListMyResponse, error) {
	...
	err := c.cc.Invoke(ctx, MyMagazineSvc_List_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *myMagazineSvcClient) ListByCategory(ctx context.Context, in *ListMyByCategoryRequest, opts ...grpc.CallOption) (*ListMyResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListMyResponse)
	err := c.cc.Invoke(ctx, MyMagazineSvc_ListByCategory_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedMyMagazineSvcServer must be embedded to have
// forward compatible implementations.
//
// NOTE: this should be embedded by value instead of pointer to avoid a nil
// pointer dereference when methods are called.
...
func (UnimplementedMyMagazineSvcServer) testEmbeddedByValue()                       {}
...
func RegisterMyMagazineSvcServer(s grpc.ServiceRegistrar, srv MyMagazineSvcServer) {
	// If the following call panics, it indicates UnimplementedMyMagazineSvcServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {

...
func (c *serviceSvcClient) Create(ctx context.Context, in *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	...
	err := c.cc.Invoke(ctx, ServiceSvc_Create_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceSvcClient) Delete(ctx context.Context, in *DeleteRequest, opts ...grpc.CallOption) (*DeleteResponse, error) {
	...
	err := c.cc.Invoke(ctx, ServiceSvc_Delete_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceSvcClient) Get(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetResponse)
	err := c.cc.Invoke(ctx, ServiceSvc_Get_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceSvcClient) List(ctx context.Context, in *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	err := c.cc.Invoke(ctx, ServiceSvc_List_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceSvcClient) AddSecret(ctx context.Context, in *AddSecretRequest, opts ...grpc.CallOption) (*AddSecretResponse, error) {
	...
	err := c.cc.Invoke(ctx, ServiceSvc_AddSecret_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceSvcClient) ActivateSecret(ctx context.Context, in *ActivateSecretRequest, opts ...grpc.CallOption) (*ActivateSecretResponse, error) {
	...
	err := c.cc.Invoke(ctx, ServiceSvc_ActivateSecret_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceSvcClient) DeactivateSecret(ctx context.Context, in *DeactivateSecretRequest, opts ...grpc.CallOption) (*DeactivateSecretResponse, error) {
	...
	err := c.cc.Invoke(ctx, ServiceSvc_DeactivateSecret_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceSvcClient) DeleteSecret(ctx context.Context, in *DeleteSecretRequest, opts ...grpc.CallOption) (*DeleteSecretResponse, error) {
	...
	err := c.cc.Invoke(ctx, ServiceSvc_DeleteSecret_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedServiceSvcServer must be embedded to have
...
func (UnimplementedServiceSvcServer) ActivateSecret(context.Context, *ActivateSecretRequest) (*ActivateSecretResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ActivateSecret not implemented")
}
func (UnimplementedServiceSvcServer) DeactivateSecret(context.Context, *DeactivateSecretRequest) (*DeactivateSecretResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method DeactivateSecret not implemented")
}
...
func (UnimplementedServiceSvcServer) testEmbeddedByValue()                    {}
...
func RegisterServiceSvcServer(s grpc.ServiceRegistrar, srv ServiceSvcServer) {
	// If the following call panics, it indicates UnimplementedServiceSvcServer was

...
type ServiceClient interface {
	...
	AuthorizeServices(ctx context.Context, in *AuthorizeServicesRequest, opts ...grpc.CallOption) (*AuthorizeServicesResponse, error)
}
...
func (c *serviceClient) AuthorizeServices(ctx context.Context, in *AuthorizeServicesRequest, opts ...grpc.CallOption) (*AuthorizeServicesResponse, error) {
	out := new(AuthorizeServicesResponse)
	err := c.cc.Invoke(ctx, "/servicesvc.Service/AuthorizeServices", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ServiceServer interface {
	...
	AuthorizeServices(context.Context, *AuthorizeServicesRequest) (*AuthorizeServicesResponse, error)
...
func (UnimplementedServiceServer) AuthorizeServices(context.Context, *AuthorizeServicesRequest) (*AuthorizeServicesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AuthorizeServices not implemented")
}
...
func _Service_AuthorizeServices_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AuthorizeServicesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ServiceServer).AuthorizeServices(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/servicesvc.Service/AuthorizeServices",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServiceServer).AuthorizeServices(ctx, req.(*AuthorizeServicesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Service_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AuthorizeServices",
			Handler:    _Service_AuthorizeServices_Handler,
		},
	},

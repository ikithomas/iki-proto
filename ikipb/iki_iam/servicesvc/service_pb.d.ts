...
export class AuthorizeServicesRequest extends jspb.Message {
  getId(): string;
  ...
  static serializeBinaryToWriter(message: AuthorizeServicesRequest, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): AuthorizeServicesRequest;
  static deserializeBinaryFromReader(message: AuthorizeServicesRequest, reader: jspb.BinaryReader): AuthorizeServicesRequest;
}
...
export class AuthorizeServicesResponse extends jspb.Message {
  getService(): ikipb_iki_iam_iam_pb.Service | undefined;
  setService(value?: ikipb_iki_iam_iam_pb.Service): AuthorizeServicesResponse;
  hasService(): boolean;
  clearService(): AuthorizeServicesResponse;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): AuthorizeServicesResponse.AsObject;
  static toObject(includeInstance: boolean, msg: AuthorizeServicesResponse): AuthorizeServicesResponse.AsObject;
  static serializeBinaryToWriter(message: AuthorizeServicesResponse, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): AuthorizeServicesResponse;
  static deserializeBinaryFromReader(message: AuthorizeServicesResponse, reader: jspb.BinaryReader): AuthorizeServicesResponse;
}

export namespace AuthorizeServicesResponse {
  export type AsObject = {
    service?: ikipb_iki_iam_iam_pb.Service.AsObject,
  }
}

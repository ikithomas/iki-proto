...
const (
	...
	Greeter_SayHellos_FullMethodName     = "/helloworld.Greeter/SayHellos"
)
...
func (c *greeterClient) SayHellos(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (Greeter_SayHellosClient, error) {
	stream, err := c.cc.NewStream(ctx, &Greeter_ServiceDesc.Streams[0], Greeter_SayHellos_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
var Greeter_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "ikipb/helloworld/helloworld.proto",
}

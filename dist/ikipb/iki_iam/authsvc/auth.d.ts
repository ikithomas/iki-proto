...
export declare const GoogleLoginResponse: {
    ...
    } & { [K_2 in Exclude<keyof I, keyof GoogleLoginResponse>]: never; }>(base?: I): GoogleLoginResponse;
    fromPartial<I_1 extends {
        accessToken?: string;
        refreshToken?: string;
        user?: {
    ...
    } & { [K_5 in Exclude<keyof I_1, keyof GoogleLoginResponse>]: never; }>(object: I_1): GoogleLoginResponse;
};

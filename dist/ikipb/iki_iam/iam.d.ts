...
export declare const User: {
    ...
    create<I extends {
        ...
        groupAdmin?: boolean;
        groupUser?: boolean;
        roles?: string[] & string[] & { [K in Exclude<keyof I["roles"], keyof string[]>]: never; };
    } & { [K_1 in Exclude<keyof I, keyof User>]: never; }>(base?: I): User;
    fromPartial<I_1 extends {
        ...
        groupAdmin?: boolean;
        groupUser?: boolean;
        roles?: string[] & string[] & { [K_2 in Exclude<keyof I_1["roles"], keyof string[]>]: never; };
